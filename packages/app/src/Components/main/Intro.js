        ...
        <Col className="input-form text-start">
          ...
          <Form onSubmit={(e) => formSubmit(e)}>
            <InputGroup>
              ...
              />
              {isVisible ? null : <Button onClick={() => setVisible(true)}>Next</Button>}
            </InputGroup>
            {isVisible ?
              (
                <div>
                  ...
                  <InputGroup>
                    ...
                    <Input required type="text" name="title" value={title} onChange={(e) => setTitle(e.target.value)} id="title" placeholder="Title" />
                  </InputGroup>
